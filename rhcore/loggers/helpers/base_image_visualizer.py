...
class BaseImageVisualizer:
    def __init__(self, logger, wnb=(1.0, 0.0), max_images=4,
                 dataformats='CHW'):
        """Create a visualizer for images.
    ...
    def __call__(
        ...
        """log comparison visualizations between different image types.
